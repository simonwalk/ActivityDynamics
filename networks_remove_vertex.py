...
num_vertices_per_iteration = 200  # This must be adjusted depending on the network used
...
def create_network(graph_name, network, strategy):
    ...
    for i in range(1, num_iterations + 1):
        ...
        nw.remove_vertex_from_graph(num_vertices_per_iteration, strategy)
...
if __name__ == '__main__':
    for network in networks_used:
        base_graph = network + " Network Remove Vertex "
        for strategy in applied_strategies:
            ...
            subtitle = "Iterations: " + str(num_iterations) + " | Vertices removed per iteration: " + str(num_vertices_per_iteration)
