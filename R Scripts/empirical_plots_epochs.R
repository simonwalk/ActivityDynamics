...
par(mar=c(5,5,4,5)+.1)
plot(sim_act_x[,1], sim_act_y[,1], type="l", pch=4, xlab=expression(tau ~ " (in days)"), ylab="Activity", lty=1, col="#000000", cex=cex_size, cex.axis=cex_paper, cex.lab=cex_paper, ylim=c(min_y, max_y))
lines(data$real_act_x, data$real_act_y, type="l", lty=1, pch=2, col="#858585")
title(expression("Activity over " ~ tau ~ " (in days)"), cex.main=cex_paper)
grid(col="gray", lwd=1)
#par(new=TRUE)
