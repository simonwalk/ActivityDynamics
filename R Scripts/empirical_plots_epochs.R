...
min_y = min(data$a_cs)
max_y = max(data$a_cs)
plot(data$a_cs, type="b", col="#000000", xlab=xlabel, ylab=expression("a"[c]), cex.axis=cex_paper, cex.lab=cex_paper, ylim=c(min_y, max_y), pch=1)
...
plot(data$ratios, type="b", col=colors[1], xlab=xlabel, ylab="ratio", cex.axis=cex_paper, cex.lab=cex_paper, ylim=c(min_y, max_y), pch=1)
...
min_y = min(data$gs)
max_y = max(data$gs)
plot(data$gs, type="b", col="#000000", xlab=xlabel, ylab=expression("g(a"[j] ~ ")"), cex.axis=cex_paper, cex.lab=cex_paper, ylim=c(min_y, max_y), pch=1)
...
plot(data$max_qs, type="b", col="#000000", xlab=xlabel, ylab="q", cex.axis=cex_paper, cex.lab=cex_paper, ylim=c(min_y, max_y), pch=1)
...
min_y = min(data$mus)
max_y = max(data$mus)
plot(data$mus, type="b", col="#000000", xlab=xlabel, ylab=expression(mu), cex.axis=cex_paper, cex.lab=cex_paper, ylim=c(min_y, max_y), pch=1)
...
par(mar=c(5,5,4,5)+.1)
plot(sim_act_x[,1], sim_act_y[,1], type="l", pch=4, xlab=xlabel, ylab="Activity", lty=1, col="#000000", cex=cex_size, cex.axis=cex_paper, cex.lab=cex_paper, ylim=c(min_y, max_y))
lines(data$real_act_x, data$real_act_y, type="l", lty=1, pch=2, col="#858585")
...
plot(errors, type="l", xlab=xlabel, ylab="Activity", lty=1, col="#000000", cex.axis=cex_paper, cex.lab=cex_paper)
title(substitute(atop("Error of Simulation",
                      "(RMSE = " ~ rmse ~ ")"), list(rmse=rmse)), cex.main=cex_paper)
grid(col="gray", lwd=1)
dev.off()