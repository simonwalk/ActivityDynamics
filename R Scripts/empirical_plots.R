...
lines(head(data$real_act_x, -1), head(data$k1s, -1), type="o", lwd=line_width, pch=1, lty=2, col=colors[2], cex=cex_size)
...
pdf("ratio_legend_dynamic.pdf", width=14, height=1)
par(mar=c(0,0,0,0))
plot.new()
...
lines(data$real_act_x, data$real_act_y, type="o", lwd=line_width, lty=1, pch=1, col=colors[2], cex=cex_size)
i = 1
...
pdf("activity_legend_dynamic.pdf", width=14, height=1)
par(mar=c(0,0,0,0))
plot.new()
